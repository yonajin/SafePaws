        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($pets)) {
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-sm btn-edit-table me-1 edit-pet-btn" data-id="<?= $row['pet_id'] ?>"><i class='bi bi-pencil'></i></button>
          ...
          <div class="modal-body bg-light">
            <div class="row g-3">
                ...
                <div class="col-md-4"><label class="form-label small text-muted">Adoption Status</label>
                  <select name="adoption_status" class="form-select"><option value="Available">Available</option><option value="Adopted">Adopted</option></select>
                </div>
